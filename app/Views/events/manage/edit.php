    ...
    <section class="mx-auto max-w-3xl space-y-6 rounded-xl bg-white p-6 shadow-sm">
        ...
        <form action="/manage/events/update" method="post">
            ...
            $field = [
                ...
                'type' => 'textarea',
                'value' => old('committee_divisions', $event['committee_divisions'] ?? ''),
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                $field = [
                    ...
                    'type' => 'datetime-local',
                    'value' => old('registration_start', $registrationStart),
                ...
                $field = [
                    ...
                    'type' => 'datetime-local',
                    'value' => old('registration_end', $registrationEnd),
            ...
            $field = [
                ...
                'type' => 'select',
                'value' => old('status', $event['status'] ?? 'draft'),
